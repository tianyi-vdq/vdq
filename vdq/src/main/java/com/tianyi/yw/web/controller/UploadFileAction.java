...
public class UploadFileAction extends BaseAction {
	 ...
	 */
	@ResponseBody
	@RequestMapping(value = "/downloadLogExcel.do")
	public void downloadLogExcelFile(HttpServletRequest request,
		...
		for (Log t : loglist) {
			...
			// 第四步，创建单元格，并设置值
			t.setCreateTimes(df.format(t.getCreateTime()));
