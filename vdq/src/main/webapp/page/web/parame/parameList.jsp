...
function savePoint(obj){
  ...
  <body>
	...
	<div id="parameInfoWindow" class="easyui-window" title="新添加参数" style="width:460px;height:280px;overflow:hidden;padding:10px;text-align:center;" iconCls="icon-info" closed="true" modal="true"   resizable="false" collapsible="false" minimizable="false" maximizable="false">
		...
		<p class="yw-window-p">
        	<span>&nbsp;&nbsp;&nbsp;&nbsp;参数名Name：</span><input name="name" type="text"  onblur="valueTrim(this);"  value="" class="easyui-validatebox" required="true"  validType="Length[1,10]" style="width:254px;height:28px;"/>
			<span style="color:red">*</span>
        </p>
        <p class="yw-window-p">
        	<span>参数关键字Key：</span><input  name="key" type="text" value="" onblur="valueTrim(this);"   class="easyui-validatebox" required="true"  validType="Length[1,25]" style="width:254px;height:28px;"/>
			<span style="color:red">*</span>
        </p>
        <p class="yw-window-p">
        	<span>&nbsp;&nbsp;&nbsp;&nbsp;参数值Value：</span><input name="value" type="text" value="" onblur="valueTrim(this);"   class="easyui-validatebox" required="true"  validType="Length[1,30]" style="width:254px;height:28px;"/>
			<span style="color:red">*</span>
        </p>
